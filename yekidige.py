...
def get_main_menu_buttons(user_id):
    ...
    if user_id == MAIN_ADMIN_ID:
        buttons.insert(2, [Button.text("مدیریت ادمین ها")])
    return buttons
...
- **مدیریت ادمین ها**: (فقط برای ادمین اصلی) برای افزودن یا حذف ادمین‌های دیگر.
...
"""
    ...
    elif text == "مدیریت ادمین ها" and event.sender_id == MAIN_ADMIN_ID:
        admin_buttons = [
